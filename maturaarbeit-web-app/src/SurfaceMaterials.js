...
const SurfaceMaterials = () => {
    ...
    const [surfaceData, setSurfaceData] = useState(
        ...
        {id: 3, name: 'Clay Roofing', color: 'rgb(210,112,0)', boundary: "true", airresistence: 10000, density: 2300, albedo: 0.36, heatcapacity: 920,  thermalconductivity: 1.4, evapotranspiration: 0.0003},
        {id: 4, name: 'Asphalt', color: 'rgb(121,121,121)', boundary: "false", airresistence: 0, density: 2360, albedo: 0.14, heatcapacity: 920,  thermalconductivity: 0.75, evapotranspiration: 0.0005},
        {id: 5, name: 'Beton', color: 'rgb(156,156,156)', boundary: "false", airresistence: 0, density: 2200, albedo: 0.35, heatcapacity: 960,  thermalconductivity: 1.4, evapotranspiration: 0.0003},
        {id: 6, name: 'Schotter', color: 'rgb(184,184,184)', boundary: "false", airresistence: 0, density: 2000, albedo: 0.4, heatcapacity: 900,  thermalconductivity: 0.7, evapotranspiration: 0.002},
