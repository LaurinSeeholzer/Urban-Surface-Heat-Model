    ...
    run() {
        ...
        for (let time = 0; time < this.iterations; time++) {
            ...
            if (h_R > 0) {
                ...
                for (let x = 0; x < this.pointsX; x++) {
                    for (let y = 0; y < this.pointsY; y++) {
                        if (solar[x][y] || this.boundary[x][y]) {
            ...
            if (this.useAirflow && Math.floor((time + 1)%(this.iterations/1000)) === 0) {
                ...
                for (let x = 0; x < this.pointsX; x++) {
                    for (let y = 0; y < this.pointsY; y++) {
                        if (this.boundary[x][y]) {
                            if (Math.floor(Math.random() * (10000 - this.airresistence[x][y])) === 0) {
                                for (let i = 0; i < 9; i++) {
